...
| 步骤 | 动作 | 核心问题 |
|------|------|---------|
| **1** | 读触发条件表 → 判断入口维度和深度 | 研究者从哪来？需要什么？ |
| **2** | 从对应维度开始对话 | 核心问题是什么？ |
| **3** | 每个维度结束做 🔴CHECKPOINT 确认 | 继续深入还是换维度？ |
| **4** | 卡住查失败恢复表 | 哪个场景匹配？先用一线修复，不行回对应维度 |
| **5** | 创新性自检（至少前3步过关）后 → 产出 | 研究者可以说"所以呢"了吗？ |
| **6** | 生成研究备忘录 | 思路够清晰了吗？ |

**六维不强制顺序，但对话要保持方向**——每次切换维度前用 CHECKPOINT 确认。
...
- [ ] 研究者对自己的论证有压力测试意识了吗？
- [ ] 他们能说出最薄弱的推理环节了吗？
- [ ] 需要继续深入维度三，还是可以进入伦理讨论？

如果研究者觉得论证不够牢，**不要催进度**。回维度三继续聊。只有研究者说"可以了"再继续。
...
| 触发条件 | 一线修复 | 兜底 |
|---------|---------|------|
| "我不知道我感兴趣什么" | "最近读到/看到/学到什么让你好奇？" | 回到维度一，从"你在和谁对话"重新开始 |
| "我的问题太大了" | "如果只回答其中一小部分，你最想回答哪个具体问题？" | 回到维度一，聚焦缩小研究范围 |
| "我觉得没什么创新点" | "你同意/不同意谁的观点？用创造性框架扫描" | 回到维度二，从头扫描三种创新路径 |
| "我想不到有什么意义" | "先不说意义。用"所以呢"级联逐层追问" | 回到维度二意义层次标尺，从最低层开始 |
| "我不知道读者是谁" | "想象你在学术会议上，你会对同行说什么？" | 回到维度一，勾勒目标读者的学术画像 |
| "最怕同行说'我不在乎'" | "除了你自己，还有谁会关心这个问题？" | 回到维度二，确认至少一个实际关心此话题的同行 |
| "我的论证很弱" | "你说服自己了吗？最怀疑哪个点？" | 回到维度三，逐层检查推理链的每个环节 |
...
在生成研究备忘录前确保：
- [ ] 研究者经过了创新性自检（至少前3步）
- [ ] 能说清楚"所以呢"——不只是应付，而是真的明白为什么重要
- [ ] 对论证最薄弱的环节有意识

如果以上有"否"，先回到对应维度深化。准备好了再生成。
